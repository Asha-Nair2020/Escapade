...
class utilities:
    ...
    def view_menu(self):
        try:
            ...
            menu_to_view = {'Option': [1,2,3,4,5,0], 'Name': ['Attractions', 'Restaurants', 'Experience Nature', 'Shopping', 'Hotels', 'Return to Main Menu']}
            print(tabulate(menu_to_view, headers="keys"), '\n')
            return menu
        except Exception as e:
            print(e)
        else:
    ...
    def view_main_menu(self):
        try:
            ...
            main_menu_to_view = {'Option': [1,2,0], 'Name': ['Search','Help', 'Exit Application']}
            print(tabulate(main_menu_to_view, headers="keys"), '\n')
            return main_menu
        except Exception as e:
            print(e)
        else:
