        ...
        while 1 == 1:
            ...
            if main_menu_option == '1':                         # Search option selected from main menu
                ...
                if option == '1' or option == '3' or option == '5':         # Attractions , Nature , Hotels - Use Tomtom API
                    user_location = utl_obj.user_input('Please enter your post-code: ')
                    ...
                    if len(df) != 0:
                        ...
                        recommendation = input("\nAre you happy with recommendation - Y/N: ")
                        if activity_choice:
                            if recommendation.upper() == "N":
                                main()
                            if recommendation.upper() == "Y":
                   ...
                   #Call the yelp API for searching restaurants and shopping centres.
                    ...
                    for i in range(len(data['businesses'])):
                        ...
                        #features['IS_OPEN'] = 'Y' if data['businesses'][i]['is_closed'] == False else 'No'
